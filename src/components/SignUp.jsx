        ...
        fetch("https://coffee-store-server-omega-lilac.vercel.app/users", {
          ...
          .then((data) => {
            ...
            if (data.insertedId) {
              Swal.fire({
                title: "Success!",
                text: "Welcome to our Coffee Community!",
                icon: "success",
                confirmButtonText: "Brew On!",
              });
        ...
        <div className="max-w-6xl w-full">
          ...
          <div className="text-center mb-8" data-aos="fade-down">
            ...
            <p className="text-amber-700 text-lg max-w-2xl mx-auto">
              Create an account to unlock premium coffee experiences, exclusive
              brewing tips, and special member discounts on our finest beans.
            </p>
          </div>
